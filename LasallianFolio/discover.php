...
<body class="sub_page">
  ...
  <section class="discover_section layout_padding2-top">
    <div class="heading_container">
      <h2>
        Dis<span>co</span>ver
      </h2>
      <p>
        Your gateway to a world of academic excellence. Explore a diverse range of student projects, research, and achievements. Unearth inspiration, connect with peers, and embark on a journey of discovery.
      </p>
    </div>
    <div class="discover_container layout_padding">
      <div class="box-1">
